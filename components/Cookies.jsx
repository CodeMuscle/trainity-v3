...
export default function Cookies() {
  ...
  const handleClose = () => setShow(false);
    return (
      <div className="pointer-events-none fixed bottom-0 right-0 px-6 pb-6">
        <div className="pointer-events-auto mx-auto max-w-xl rounded-xl bg-white p-6 shadow-lg ring-1 ring-gray-900/10">
          ...
          <div className="mt-4 flex items-center gap-x-5">
            ...
            <button onHide={handleClose} type="button" className="text-sm font-semibold leading-6 text-gray-900">
              Reject
            </button>
          </div>
        </div>
